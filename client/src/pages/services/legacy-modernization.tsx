...
export default function LegacyModernization() {
  ...
  const contactMutation = useMutation({
    mutationFn: async (data: ContactForm) => {
      return apiRequest("/api/contact", {
        method: "POST",
        body: JSON.stringify({ ...data, service: "Legacy Application Modernization" }),
      });
    },
    onSuccess: () => {
      reset();
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[500px] overflow-hidden bg-gradient-to-r from-orange-600 via-red-600 to-pink-700 -mt-40 pt-40">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <h1 className="font-montserrat font-bold text-4xl lg:text-5xl xl:text-6xl leading-tight mb-6">
                ...
                <br />
                <span className="text-orange-300">From Legacy to Leading Edge</span>
              </h1>
